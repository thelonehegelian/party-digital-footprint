...
from src.models import Base, Message, Source, Candidate, Constituency, MessageSentiment, TopicModel, MessageTopic, Party
...
def sample_data_with_topics(db_session):
    ...
    party = Party(
        ...
        short_name="TPP",
        description="Test party for topic analytics",
